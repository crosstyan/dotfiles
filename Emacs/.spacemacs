...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(yaml
     ...
     markdown
     multiple-cursors
     ;; You should disable it if you are in Linux/OSX
     ;; windows-scripts ;; it's bad even in Windows
     org
     (shell :variables
     ...
     themes-megapack
     chinese
     ;; xclipboard. This config is for WSL. If you are running in real Linux You
     ;; should use other command
     emoji
     (xclipboard
   ...
   ;; 移除了 "pyim" 在 Windows 环境下无用
   dotspacemacs-excluded-packages '(pyim
                                    org-contrib)
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; I love Cascadia and the light weight is best in small size.
   ...
   ;; I don't like showing trailing space.
   ;; If I do I will just show all white marks.
   ;; or just SPC x d w
...
(defun dotspacemacs/user-load () "Library to load while dumping. This function is called only while dumping Spacemacs configuration. You can
...
before packages are loaded."
  ...
  ;; Moving frame Inspired by
  ;; https://www.reddit.com/r/emacs/comments/4d8tkd/setting_personal_keybindings_in_spacemacs/
  ;; Lovely when you are using WSL without frame. I still prefer let window
  ;; manager to handle this. Although I can't have window manager work in
  ;; WSLg. Maybe I should try native X Server. 
  ;; Maybe I should create a minor mode for this
  ;; but I'm lazy. 
  ;; (load-file "~/.spacemacs.d/packages/frame-fns.el")
  ;; (load-file "~/.spacemacs.d/packages/frame-cmds.el")
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(emojify emoji-cheat-sheet-plus company-emoji flyspell-correct-helm flyspell-correct auto-dictionary zenburn-theme zen-and-art-theme yasnippet-snippets yaml-mode xterm-color ws-butler writeroom-mode winum white-sand-theme which-key vterm vscode-dark-plus-theme volatile-highlights vi-tilde-fringe uuidgen use-package unfill undo-tree underwater-theme ujelly-theme twilight-theme twilight-bright-theme twilight-anti-bright-theme treemacs-projectile treemacs-persp treemacs-magit treemacs-icons-dired treemacs-evil toxi-theme toc-org terminal-here tao-theme tangotango-theme tango-plus-theme tango-2-theme symon symbol-overlay sunny-day-theme sublime-themes subatomic256-theme subatomic-theme string-inflection string-edit spaceline-all-the-icons spacegray-theme soothe-theme solarized-theme soft-stone-theme soft-morning-theme soft-charcoal-theme smyx-theme smeargle sis shell-pop seti-theme rime reverse-theme restart-emacs rebecca-theme rainbow-delimiters railscasts-theme quickrun purple-haze-theme professional-theme popwin planet-theme phoenix-dark-pink-theme phoenix-dark-mono-theme pcre2el password-generator paradox pangu-spacing overseer orgit-forge organic-green-theme org-superstar org-rich-yank org-projectile org-present org-pomodoro org-mime org-download org-cliplink open-junk-file omtose-phellack-theme oldlace-theme occidental-theme obsidian-theme noctilux-theme naquadah-theme nameless mwim mustang-theme multi-term multi-line monokai-theme monochrome-theme molokai-theme moe-theme modus-vivendi-theme modus-operandi-theme mmm-mode minimal-theme material-theme markdown-toc majapahit-theme madhat2r-theme macrostep lush-theme lsp-ui lsp-treemacs lsp-origami lorem-ipsum link-hint light-soap-theme kaolin-themes jbeans-theme jazz-theme ir-black-theme inkpot-theme indent-guide hybrid-mode hungry-delete htmlize hl-todo highlight-parentheses highlight-numbers highlight-indentation heroku-theme hemisu-theme helm-xref helm-themes helm-swoop helm-purpose helm-projectile helm-org-rifle helm-org helm-mode-manager helm-make helm-lsp helm-ls-git helm-gitignore helm-git-grep helm-flx helm-descbinds helm-company helm-cider helm-c-yasnippet helm-ag hc-zenburn-theme gruvbox-theme gruber-darker-theme grandshell-theme gotham-theme google-translate golden-ratio gnuplot gitignore-templates gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe+ gh-md gandalf-theme fuzzy font-lock+ flycheck-pos-tip flycheck-package flycheck-elsa flx-ido flatui-theme flatland-theme find-by-pinyin-dired farmhouse-theme fancy-battery eziam-theme eyebrowse expand-region exotica-theme evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-textobj-line evil-surround evil-snipe evil-org evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-lisp-state evil-lion evil-indent-plus evil-iedit-state evil-goggles evil-exchange evil-escape evil-ediff evil-easymotion evil-collection evil-cleverparens evil-args evil-anzu espresso-theme eshell-z eshell-prompt-extras esh-help emr elisp-slime-nav editorconfig dumb-jump drag-stuff dracula-theme dotenv-mode doom-themes django-theme dired-quick-sort diminish define-word darktooth-theme darkokai-theme darkmine-theme darkburn-theme dakrone-theme cyberpunk-theme column-enforce-mode color-theme-sanityinc-tomorrow color-theme-sanityinc-solarized clues-theme clojure-snippets clean-aindent-mode cider-eval-sexp-fu chocolate-theme chinese-conv cherry-blossom-theme centered-cursor-mode busybee-theme bubbleberry-theme browse-at-remote birds-of-paradise-plus-theme badwolf-theme auto-yasnippet auto-highlight-symbol auto-compile apropospriate-theme anti-zenburn-theme ample-zen-theme ample-theme alect-themes aggressive-indent afternoon-theme ace-pinyin ace-link ace-jump-helm-line ac-ispell)))
(custom-set-faces
